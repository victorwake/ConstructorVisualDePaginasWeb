    ...
    <aside className="w-56 h-full bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-1">
        {components.map((comp) => (
          <div
            key={comp.type}
            className="flex items-center gap-3 px-3 py-2 rounded-md text-sm text-gray-700 hover:bg-gray-100 cursor-grab active:cursor-grabbing select-none transition-colors"
            draggable
          >
